...
function module_mapc_thum_make($path_original, $path_thum, $file_name, $mime_type, $option = ['max' => 1024, 'min' => 768]) {
    ...
    // 확장자가 jpg면 -> imagecreatefromjpeg()
    $mime_type = 'jpg' ? 'jpeg' : $mime_type;
