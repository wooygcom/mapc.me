...
require(INIT_PATH . 'init.form.php');
{ // Model : Head

    { // BLOCK:get_config:20150205:환경설정 가져오기

        $userConfig = include_once(MODULE_PATH . 'user/config/config.php');
    ...
    { // BLOCK:data:20150215:필요한 값들 설정하기
        ...
        $VIEW['csrf']   = $_SESSION['csrf'];
        $VIEW['actUrl'] = $userConfig['url']['root'] . 'sign-in/';
