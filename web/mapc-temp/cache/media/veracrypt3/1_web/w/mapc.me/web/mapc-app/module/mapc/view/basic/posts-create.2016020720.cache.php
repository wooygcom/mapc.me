...
<form method="post" action="/w/mapc.me/web/mapc-public/mapc/posts/create" role="form" class="dropzone" enctype="multipart/form-data">
    ...
    <input type="hidden" name="link_to" value="/w/mapc.me/web/mapc-public/mapc/posts/create" />
