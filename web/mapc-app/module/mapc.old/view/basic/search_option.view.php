...
if(count($search_option['dc_language']) > 0) {
    foreach($search_option['dc_language'] as $key => $var) {
...
?>
        ...
        <li>
            ...
            <div class="form-group">
<?php
if(count($search_option['dc_subject']) > 0) {
    foreach($search_option['dc_subject'] as $key => $var) {
...
?>
        ...
        <li>
            ...
            <div class="form-group">
<?php
if(count($search_option['dc_type']) > 0) {
    foreach($search_option['dc_type'] as $key => $var) {
...
?>
        ...
        <li>
            ...
            <div class="form-group">
<?php
if(count($search_option['dc_format']) > 0) {
    foreach($search_option['dc_format'] as $key => $var) {
...
?>
        ...
        <li>
            ...
            <div class="form-group">
<?php
if(count($search_option['dc_coverage']) > 0) {
    foreach($search_option['dc_coverage'] as $key => $var) {
