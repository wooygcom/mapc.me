<?php
	...
	function module_paging_gen($arg) {
		...
		$blockSet	= $arg['blockSet']	? $arg['blockSet']	: 5;

		// $curr(현재글번호)가 있을 경우 $curr값을 가지고 몇번째 페이지인지 알아내기 (공식 : floor(($curr - 1) / $pageSet) * $pageSet)
		$page = $curr ? floor(($curr - 1) / $pageSet) : $page;
